...
export ssgamtree_path=/home/pi/trees/

####for raspberry pi.################################################
echo performance > /sys/devices/system/cpu/cpu0/cpufreq/scaling_governor
#######################################################################
#export STATUS_PATH=./MARTe2_armv8/Resources/HTTP
...
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$MARTe2_DIR/Build/armv8-linux/Examples/Core/
...
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$MARTe2_Components_DIR/Build/armv8-linux/Components/DataSources/OPCUADataSource/
...
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$MARTe2_Components_DIR/Build/armv8-linux/Components/GAMs/PIDGAM/
...
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$MARTe2_Components_DIR/Build/armv8-linux/Components/Interfaces/OPCUA/
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$MARTe2_Components_DIR/Build/armv8-linux/Components/Interfaces/EspWebTool/
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$MARTe2_DIR/../open62541/build/bin/
